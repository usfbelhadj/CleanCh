...
class _MapScreenState extends State<MapScreen>
  ...
  bool hasInternet = true; // Store the internet connectivity status

  // Check internet connectivity and set the 'hasInternet' flag
  Future<void> _checkInternetAndShowDialog() async {
    ...
    // Set the 'hasInternet' flag and trigger a rebuild
    setState(() {});
  }
  ...
  void initState() {
    super.initState();
    _getCurrentLocation();
    // Check internet connectivity only once in the initState
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          // Loading or empty container based on 'hasInternet'
          hasInternet
              ? FlutterMap(
